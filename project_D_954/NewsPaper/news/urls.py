...
from .views import AuthorDetail, AuthorList, CategoryList, PostList, PostDetail, PostCreate, PostDelete, PostEdit, PostSearch, PostsOfCategoryList, subscribe
...
urlpatterns = [
    ...
    #path('category/<int:pk>/', CategoryListView.as_view(), name='category_list3'),
