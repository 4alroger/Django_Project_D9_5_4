...
def send_notifications(preview, pk, title, subscribers):
    ...
    msg = EmailMultiAlternatives(
        ...
        to=['*******@yandex.ru'],    # тут пишем to=subscribe для отправки на почту подписчикам, для теста моя
    )
...
# class CategoryListView(ListView):
#     model = Post
#     template_name = 'category_list3.html'
#     context_object_name = 'category_news_list3'
